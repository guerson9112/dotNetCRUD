...
namespace ProductAPI.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public IActionResult CreateProduct( [FromBody] ProductDTO productDTO)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, $"Ha ocurrido un error guardando el producto {productDTO.Name}");
        ...
        public IActionResult UpdateProduct(int id, [FromBody] ProductDTO productDTO)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, $"Ha ocurrido un error actualizando el producto {productDTO.Name}");
                return StatusCode(500, ModelState);
            }
        ...
        public IActionResult DeleteProduct(int id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, $"Ha ocurrido un error eliminando el producto {product.Name}");
                return StatusCode(500, ModelState);
            }
